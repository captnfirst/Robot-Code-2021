...
public class AdaptivePurePursuitController {
    ...
    public double[] update(Trajectory trajectory, Pose2d currentRobotPose, double heading, boolean reversed) {
    ...
    private static double calculateCurvature(
        ...
        double curvature =
                (2.0 * x) / (Math.pow(Constants.DriveConstants.kPurePursuitLookAheadDistance, 2.0));
        double side =
                Math.signum(
