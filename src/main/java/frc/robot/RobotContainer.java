...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // Kafa Dönme Auto
    new JoystickButton(m_driverController, 2).whileHeld(new AutoAlign(m_turret,m_led));
    ...
    new JoystickButton(m_driverController, 3).whileHeld(new TurretPIDCommand(m_turret,m_led));
    ...
    new JoystickButton(m_operatorController, 11).whileHeld(new DefaultManuallyAuto(autoAlign, m_turret, m_shooter, m_trigger, m_push,m_led));
  ...
  public Command getAutonomousCommand() {
    ...
    return new Auto6Balls(m_robotDrive, m_intake, m_turret, m_shooter, m_trigger, m_push, m_led);
  }
}
