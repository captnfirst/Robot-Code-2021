...
import frc.robot.commands.Auto.DefaultManuallyAuto;
...
public class RobotContainer {
  ...
  AutoAlign autoAlign = new AutoAlign(m_vision, m_turret, m_led);
  ...
  private void configureButtonBindings() {
    ...
    // Kafa Dönme Auto
    new JoystickButton(m_driverController, 2).whileHeld(new AutoAlign(m_vision,m_turret,m_led));
    ...
    new JoystickButton(m_operatorController, 11).whileHeld(new DefaultManuallyAuto(m_vision, autoAlign, m_turret, m_shooter, m_trigger, m_push,m_led));
  ...
  public Command getAutonomousCommand() {
    ...
    return new DefaultAuto(m_vision,autoAlign, m_turret, m_shooter, m_trigger, m_robotDrive, m_push,m_led);
  }
}
