...
import frc.robot.commands.Turret.TurretVisionControl;
...
import frc.robot.subsystems.VisionCamSubsystem;
...
public class RobotContainer {
  ...
  public final VisionCamSubsystem m_vision = new VisionCamSubsystem();
  ...
  private void configureButtonBindings() {
    ...
    // Kafa Dönme Auto
    new JoystickButton(m_driverController, 2).whileHeld(new TurretVisionControl(m_turret));
