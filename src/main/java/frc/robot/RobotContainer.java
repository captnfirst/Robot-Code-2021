...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // Kafa Dönme Auto
    new JoystickButton(m_driverController, 2).whileHeld(new AutoAlign(m_vision,m_turret));
    ...
    new JoystickButton(m_operatorController, 11).whileHeld(new DefaultManuallyAuto(m_vision, m_turret, m_shooter, m_trigger, m_push));
  ...
  public Command getAutonomousCommand() {
    ...
    return new DefaultAuto(m_vision, m_turret, m_shooter, m_trigger, m_robotDrive, m_push);
  }
}
